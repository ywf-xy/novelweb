...
<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/wuxia.css"/>
		<script src="${pageContext.request.contextPath}/static/js/jquery-3.4.1.js" type="text/javascript"
		        charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/static/js/wuxia.js" type="text/javascript"
		        charset="UTF-8"></script>
...
<div class="NavBar">
		<div>
				...
				<a href="" class='now'><span>武侠</span></a>
...
<div class="Main">
		<div class="Mina_left">
				<div id="Mian_left_head"><h2>武侠</h2></div>
