...
<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/xuanhuan.css"/>
		<script src="${pageContext.request.contextPath}/static/js/jquery-3.4.1.js" type="text/javascript"
		        charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/static/js/xuanhuan.js" type="text/javascript"
		        charset="UTF-8"></script>
...
<div class="NavBar">
		<div>
				...
				<a href="" class='now'><span>玄幻</span></a>
