					...
					function (data) {
							if (data.flag) {
									...
									for (var i = 0; i < novels.length; i++) {
											...
											console.log(novels[i].book_name + " encoding=" + escape(novels[i].book_name))
											...
											$(".book_list").append("<dl>\n" +
												...
												"                    <dd>类别：<span class=\"book_type\">科幻</span></dd>\n" +
									...
									if (flag == 1) {
											...
											for (var i = 0; i < 10; i++) {
													...
													$(".rank_list_ul li a").eq(i).text(download[i].book_name);
													als[i].href = "/wfRead/novel/book/" + download[i].book_name
													$(".rank_list_ul li a").eq(i + 10).text(monthticket[i].book_name);
													als[i + 10].href = "/wfRead/novel/book/" + monthticket[i].book_name;
													$(".rank_list_ul li a").eq(i + 20).text(collection[i].book_name);
